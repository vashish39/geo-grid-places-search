...
// Write dashboard-config.js so the browser dashboard can use the same key automatically
writeFileSync(
  "dashboard-config.js",
  `/* Auto-generated by main.ts — do not commit (already in .gitignore) */\nwindow.GOOGLE_API_KEY = ${JSON.stringify(API_KEY)};\n`,
  "utf8"
);
...
async function run(
  ...
  const fileName = `exports/places_${city.replace(/\s+/g, "_")}.csv`;
